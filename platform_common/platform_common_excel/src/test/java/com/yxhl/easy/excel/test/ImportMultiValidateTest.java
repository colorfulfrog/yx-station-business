...
import com.yxhl.easy.excel.parsing.ExcelError;
import com.yxhl.easy.excel.result.ExcelImportResult;
...
public class ImportMultiValidateTest {
	...
	// 配置文件路径
	private static ExcelContext context = ExcelContext.newInstance("excel-config.xml");
	// Excel配置文件中配置的id
	private static String excelId = "student2";
	
	/**
	 * 导入Excel,使用了com.yxhl.easy.excel.test.ExportTest.testExportCustomHeader()方法生成的Excel
	 * @throws Exception
	 */
	@Test
	public void testImport()throws Exception{
		...
		ExcelImportResult result = context.readExcel(excelId,  resource.getInputStream(),true);
