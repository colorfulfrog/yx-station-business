...
import com.elead.platform.common.web.annotation.Logined;

/**
 * 判断用户是否登录，不登录不能访问controller。
 * 需要验证的方法增加注解com.elead.platform.common.web.annotation.Logined
 * @see com.elead.platform.common.web.annotation.Logined
 * @author liutao
 *
 */
@Component
